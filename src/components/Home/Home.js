...
class Home extends Component {
    render() {
        ...
        let subheading = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore";
        return (
            <div>
                <section className="hero">
                    <div className="hero-body">
                        <div className="container">
                            ...
                            <a id="learn" className="button is-large is-primary">Learn More</a>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container">
                        ...
                        <div className="columns pd">
                            ...
                            <div className="column">
                                <div className="card">
                                    <div className="card-content">
                                        <p className="title">"I think it's an absolutely excellent tool for our business</p>
                                        <p className="subtitle">- Gary Simon</p>
                                    </div>
                                </div>
                            </div>
